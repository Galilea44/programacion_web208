/* function generarQR(){
    let var1= document.getElementById('input1').ariaValueMax.trim();
    let var2= document.getElementById('input2').ariaValueMax.trim();
    let var3= document.getElementById('input3').ariaValueMax.trim();
    let var4= document.getElementById('input4').ariaValueMax.trim();
